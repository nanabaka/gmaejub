    ...
    <header className="sticky top-0 z-40 w-full bg-white border-b border-gray-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        <Link href="/" className="flex items-center gap-3 group">
          <div className="flex items-center justify-center w-9 h-9 rounded-lg bg-gray-900 text-white group-hover:bg-black transition-colors">
        ...
        {/* Live Status & Counter Badge (Only when totalCount is provided) */}
        <div className="flex items-center gap-3">
          ...
          {/* Refresh Button (Only when onRefresh is provided) */}
          {onRefresh && (
            <button
              onClick={onRefresh}
              disabled={isLoading}
